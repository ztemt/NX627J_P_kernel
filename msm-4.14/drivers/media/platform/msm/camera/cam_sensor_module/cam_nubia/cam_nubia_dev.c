...
#define CAL_DATA_ADDR    0x158F   //nubia songliang add for CalibrationData
...
/*ZTEMT: songliangliang add for write calibration--------Start*/
...
/*ZTEMT: songliangliang add for write calibration--------end*/
