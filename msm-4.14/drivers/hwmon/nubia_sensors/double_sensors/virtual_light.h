...
#define NUBIA_LIGHT_NOTIFY_LCD

#ifdef NUBIA_LIGHT_NOTIFY_LCD
#define LCD_BACK_BIT			BIT(2)
#define LCD_FRONT_BIT			BIT(1)
#define LCD_FRONT_BACK_BIT      (BIT(1)|BIT(2))
#endif
...
#ifdef NUBIA_LIGHT_NOTIFY_LCD
    struct notifier_block light_fb_notify;
	u64 lcd_stat;
#endif
    u8 debug_level;
};
