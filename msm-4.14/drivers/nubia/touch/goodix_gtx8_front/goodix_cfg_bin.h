...
#define TS_DEFAULT_CFG_BIN_V0 "goodix_front_cfg_group.bin"
#define TS_CFG_BIN_V1 "goodix_front_cfg_group_1.bin"
#define TS_CFG_BIN_V2 "goodix_front_cfg_group_2.bin"
...
int goodix_front_read_cfg_bin(struct device *dev, struct goodix_cfg_bin *cfg_bin, struct goodix_ts_core *core_data);
